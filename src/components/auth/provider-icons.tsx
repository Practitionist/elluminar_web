/**
 * Brand marks. lucide-react deliberately ships no third-party logos, and the
 * CSP in next.config.ts would let us load one remotely — but an inline SVG
 * costs no request and can't break when a CDN does.
 */
