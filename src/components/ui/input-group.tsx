...
const inputGroupVariants = cva(
  ...
  {
    variants: {
      // Mirrors the Input size variant so the wrapper and the control agree.
      size: { default: "h-8", lg: "h-10" },
    },
...
function InputGroupInput({
  ...
  return (
    <Input
      ...
      className={cn(
        // h-full rather than a size variant: the control adopts whatever height
        // the surrounding InputGroup was given.
